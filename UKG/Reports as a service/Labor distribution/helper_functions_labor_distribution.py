...
def retrieve_employee_allocation_report(report_file_path):
    """This is similar to the retrieve_report() function, but is specific for the employee allocation report""" 
    ...
    #Rename the columns in the dataframe, using column_names_lst
    df.columns = ['Employee', 'Employee Name', 'Job', 'Pay Group', 'Location', 'Location Code', 'Annual', 'Hourly', 'Employment Status', 'Allocation', 'Job Code', 'Location Code2', 'Location2', 'Org Level 3 Code', 'Scheduled Work Hours']
...
def create_sql_table_v2(table_name):
    ...
    cursor.execute(
        ...
        r"""FROM 'C:\BI_WH_Solution\Zack_Python_Code\BI_Python_API_Code\UKG\Reports as a service\Labor distribution\ukg_bulk_insert.csv'
        WITH (
        FIELDTERMINATOR = ',',
        ROWTERMINATOR = '\n',
        FIRSTROW = 2)"""
